...
const SideBar = () => {
  ...
  return (
    <div className='ml-3 h-screen md:overflow-hidden overflow-auto md:hoveroverflow-auto pb-10'>
      {activeMenu &&(<>
      <div className='flex justify-between items-center'>
        ...
        <TooltipComponent content="Menu" position='Bottom Center'>
          <button type='button' onClick={()=>{}} className="text-xl p-3 hover::bg-light-gray mt-4 block md:hidden"><MdOutlineCancel/></button>
        </TooltipComponent>
      </div>
      <div className='mt-10 '>
        {links.map((item)=>
